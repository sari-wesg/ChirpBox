...
#define RFLR_MODEMSTAT_MODEM_STATUS_HEADER_MASK     0x08
#define RFLR_MODEMSTAT_MODEM_STATUS_SYNC_MASK       0x02
#define RFLR_MODEMSTAT_MODEM_STATUS_SIGNAL_MASK     0x01
