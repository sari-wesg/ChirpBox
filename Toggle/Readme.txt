...
4) The testbed just supports ARMCC and GUN compilers.

5) You should write all the user's data at one time. We provide writing and reading methods for byte by byte.
