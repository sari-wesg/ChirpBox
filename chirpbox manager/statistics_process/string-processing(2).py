...
Round_Count = 0
with open("glossy_data/glossy_"+'ct11_version_used_sf7_slot_num80_payload_len_11(20200914214701085605)_data'+".txt","w") as f_target:

    for node in range(total_node_num):
        if (node!=79):
            #open original txt 
            # f_original = open("./sf7_12nodes(1F1173)_3.txt")
            f_original = open("glossy_data/ct11_version_used_sf7_slot_num80_payload_len_11(20200914214701085605).txt")
