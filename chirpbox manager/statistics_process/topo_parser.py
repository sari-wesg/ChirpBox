...
def topo_parser(filename, using_pos):
    ...
    if (using_pos == 1):
        ...
        if (using_pos == 2):
            pos = {0: [331, 309], 1: [378, 307], 2: [207, 415], 3: [340, 317], 4: [902, 284], 5: [878, 14], 6: [251, 340], 7: [320, 157], 8: [56, 217], 9: [257, 169], 10: [340, 309], 11: [329, 759], 12: [470, 242], 13: [423, 237], 14: [672, 496], 15: [424, 561], 16: [805, 526], 17: [628, 701], 18: [592, 562], 19: [763, 704], 20: [229, 645], 21: [458, 716]}
